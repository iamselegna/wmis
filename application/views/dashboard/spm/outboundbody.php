        ...
        <div class="container-fluid">
            ...
            foreach ($tabledata as $rows) {
                echo '<tr>';
                echo '<td scope="row"><a class="btn btn-primary btn-block" href="' . base_url('dashboard/spmoutbound/viewdetails/' . $rows['OutboundId']) . '" role="button">View Details</a></td>';
                echo '<td scope="row">' . $rows['WmDrNo'] . '</td>';
                echo '<td scope="row">' . $rows['ApcDrNo'] . '</td>';
                echo '<td>' . date('F j, Y', strtotime($rows['DateOut'])) . '</td>';
                echo '</tr>';
            }
        ?>
                        </tbody>
